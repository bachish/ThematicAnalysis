...
public:
	...
	static bool executeExeWithParams(const std::string& exePath, const std::string& params, std::string& output);
	static bool executeExeWithParams(const std::string& exePath, const std::string& params);
};
