...
namespace Solarix
{
    ...
    public:
        ...
        virtual ~WordFormEnumerator_File1() {}

        virtual bool Fetch() override;
        virtual int GetEntryKey() override;
        virtual int GetFormIndex() override;

        virtual float GetValue() override;
        virtual int GetMatchedWordIndex() override;
    };
    ...
    public:
        ...
        virtual ~WordFormEnumerator_File2() {}
