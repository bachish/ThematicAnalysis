...
const int NUM_WORD_CLASS = 2;                      // class num_word
const int NOUN_ru = 6;                             // class СУЩЕСТВИТЕЛЬНОЕ
const int PRONOUN2_ru = 7;                         // class МЕСТОИМ_СУЩ
const int PRONOUN_ru = 8;                          // class МЕСТОИМЕНИЕ
const int ADJ_ru = 9;                              // class ПРИЛАГАТЕЛЬНОЕ
const int NUMBER_CLASS_ru = 10;                    // class ЧИСЛИТЕЛЬНОЕ
const int INFINITIVE_ru = 11;                      // class ИНФИНИТИВ
const int VERB_ru = 12;                            // class ГЛАГОЛ
const int GERUND_2_ru = 13;                        // class ДЕЕПРИЧАСТИЕ
const int PREPOS_ru = 14;                          // class ПРЕДЛОГ
const int IMPERSONAL_VERB_ru = 15;                 // class БЕЗЛИЧ_ГЛАГОЛ
const int PARTICLE_ru = 18;                        // class ЧАСТИЦА
const int CONJ_ru = 19;                            // class СОЮЗ
const int ADVERB_ru = 20;                          // class НАРЕЧИЕ
const int PUNCTUATION_class = 21;                  // class ПУНКТУАТОР
const int POSTPOS_ru = 26;                         // class ПОСЛЕЛОГ
const int POSESS_PARTICLE = 27;                    // class ПРИТЯЖ_ЧАСТИЦА
const int MEASURE_UNIT = 28;                       // class ЕДИНИЦА_ИЗМЕРЕНИЯ
const int COMPOUND_ADJ_PREFIX = 29;                // class ПРЕФИКС_СОСТАВ_ПРИЛ
const int COMPOUND_NOUN_PREFIX = 30;               // class ПРЕФИКС_СОСТАВ_СУЩ
const int VERB_en = 31;                            // class ENG_VERB
const int BEVERB_en = 32;                          // class ENG_BEVERB
const int AUXVERB_en = 33;                         // class ENG_AUXVERB
const int NOUN_en = 34;                            // class ENG_NOUN
const int PRONOUN_en = 35;                         // class ENG_PRONOUN
const int ARTICLE_en = 36;                         // class ENG_ARTICLE
const int PREP_en = 37;                            // class ENG_PREP
const int POSTPOS_en = 38;                         // class ENG_POSTPOS
const int CONJ_en = 39;                            // class ENG_CONJ
const int ADV_en = 40;                             // class ENG_ADVERB
const int ADJ_en = 41;                             // class ENG_ADJECTIVE
const int PARTICLE_en = 42;                        // class ENG_PARTICLE
const int NUMERAL_en = 43;                         // class ENG_NUMERAL
const int INTERJECTION_en = 44;                    // class ENG_INTERJECTION
const int POSSESSION_PARTICLE_en = 45;             // class ENG_POSSESSION
const int COMPOUND_PRENOUN_en = 46;                // class ENG_COMPOUND_PRENOUN
const int COMPOUND_PREADJ_en = 47;                 // class ENG_COMPOUND_PREADJ
const int COMPOUND_PREVERB_en = 48;                // class ENG_COMPOUND_PREVERB
const int COMPOUND_PREADV_en = 49;                 // class ENG_COMPOUND_PREADV
const int NUMERAL_fr = 50;                         // class FR_NUMERAL
const int ARTICLE_fr = 51;                         // class FR_ARTICLE
const int PREP_fr = 52;                            // class FR_PREP
const int ADV_fr = 53;                             // class FR_ADVERB
const int CONJ_fr = 54;                            // class FR_CONJ
const int NOUN_fr = 55;                            // class FR_NOUN
const int ADJ_fr = 56;                             // class FR_ADJ
const int PRONOUN_fr = 57;                         // class FR_PRONOUN
const int VERB_fr = 58;                            // class FR_VERB
const int PARTICLE_fr = 59;                        // class FR_PARTICLE
const int PRONOUN2_fr = 60;                        // class FR_PRONOUN2
const int NOUN_es = 61;                            // class ES_NOUN
const int ROOT_es = 62;                            // class ES_ROOT
const int JAP_NOUN = 63;                           // class JAP_NOUN
const int JAP_NUMBER = 64;                         // class JAP_NUMBER
const int JAP_ADJECTIVE = 65;                      // class JAP_ADJECTIVE
const int JAP_ADVERB = 66;                         // class JAP_ADVERB
const int JAP_CONJ = 67;                           // class JAP_CONJ
const int JAP_VERB = 68;                           // class JAP_VERB
const int JAP_PRONOUN = 69;                        // class JAP_PRONOUN
const int JAP_VERB_POSTFIX2 = 72;                  // class JAP_VERB_POSTFIX2
const int JAP_PARTICLE = 74;                       // class JAP_PARTICLE
const int UNKNOWN_ENTRIES_CLASS = 85;              // class UnknownEntries
// ------------------------------------------------------------



const int CharCasing = 4;                          // enum CharCasing
...
const int TRANSITIVENESS_ru = 30;                  // enum ПЕРЕХОДНОСТЬ
...
const int SHORTNESS_ru = 37;                       // enum КРАТКИЙ

const int CASE_ru = 39;                            // enum ПАДЕЖ
...
const int ABBREV_FORM_ru = 4;                      // СТЕПЕНЬ : СОКРАЩ

const int CASE_GERUND_ru = 43;                     // enum ПадежВал
// Coordiname ПадежВал states:

const int MODAL_ru = 44;                           // enum МОДАЛЬНЫЙ

const int VERBMODE_TENSE = 45;                     // enum СГД_Время
// Coordiname СГД_Время states:

const int VERBMODE_DIRECTION = 46;                 // enum СГД_Направление
// Coordiname СГД_Направление states:

const int NUMERAL_CATEGORY = 47;                   // enum КАТЕГОРИЯ_ЧИСЛ
// Coordiname КАТЕГОРИЯ_ЧИСЛ states:
const int CARDINAL = 0;                            // КАТЕГОРИЯ_ЧИСЛ : КОЛИЧ
const int COLLECTION = 1;                          // КАТЕГОРИЯ_ЧИСЛ : СОБИР

const int ADV_SEMANTICS = 48;                      // enum ОБСТ_ВАЛ
...
const int ADJ_TYPE = 49;                           // enum ТИП_ПРИЛ
// Coordiname ТИП_ПРИЛ states:
const int ADJ_POSSESSIVE = 0;                      // ТИП_ПРИЛ : ПРИТЯЖ
const int ADJ_ORDINAL = 1;                         // ТИП_ПРИЛ : ПОРЯДК

const int PRONOUN_TYPE_ru = 51;                    // enum ТИП_МЕСТОИМЕНИЯ
// Coordiname ТИП_МЕСТОИМЕНИЯ states:

const int VERB_TYPE_ru = 52;                       // enum ТИП_ГЛАГОЛА
// Coordiname ТИП_ГЛАГОЛА states:
const int COPULA_VERB_ru = 2;                      // ТИП_ГЛАГОЛА : СВЯЗОЧН

const int PARTICLE_TYPE = 53;                      // enum ТИП_ЧАСТИЦЫ
...
const int ADV_MODIF_TYPE = 54;                     // enum ТИП_МОДИФ
// Coordiname ТИП_МОДИФ states:

const int TENSE_en = 55;                           // enum TENSE
...
const int IMPERATIVE_en = 3;                       // TENSE : IMPERATIVE

const int DURATION_en = 56;                        // enum DURATION
...
const int HAS_POSSESSIVE_FORM_en = 60;             // enum HAS_POSSESSIVE_FORM

const int PRONOUN_FORM_en = 61;                    // enum PRONOUN_FORM
// Coordiname PRONOUN_FORM states:

const int ADJ_FORM_en = 62;                        // enum ADJ_FORM
...
const int COMPARABILITY_en = 63;                   // enum COMPARABILITY
...
const int OBLIG_TRANSITIVITY_en = 69;              // enum OBLIG_TRANSITIVITY
// Coordiname OBLIG_TRANSITIVITY states:

const int VERB_SLOTS_en = 70;                      // enum VERB_SLOTS
// Coordiname VERB_SLOTS states:
const int DITRANSITIVE_en = 0;                     // VERB_SLOTS : DITRANSITIVE
const int COPULATIVE_en = 1;                       // VERB_SLOTS : COPULATIVE
const int GERUND_en = 2;                           // VERB_SLOTS : GERUND
const int PastParticipleSlot_en = 3;               // VERB_SLOTS : PastParticiple
const int DIRECT_MODALITY_en = 4;                  // VERB_SLOTS : ModalDirect
const int TO_MODALITY_en = 5;                      // VERB_SLOTS : ModalTo

const int PROPER_NOUN_en = 71;                     // enum ENG_PROPER_NOUN

const int MASS_NOUN_en = 72;                       // enum ENG_MASS_NOUN

const int MODAL_NOUN_en = 73;                      // enum ENG_MODAL_NOUN

const int PERSON_fr = 77;                          // enum FR_PERSON
...
const int FR_PRONOUN_FORM = 81;                    // enum FR_PRONOUN_FORM
...
const int TRANSITIVITY_fr = 82;                    // enum FR_TRANSITIVITY
...
const int VERB_FORM_fr = 83;                       // enum FR_VERB_FORM
...
const int JAP_FORM = 84;                           // enum JAP_FORM
...
const int JAP_VERB_BASE = 85;                      // enum JAP_VERB_BASE
...
const int JAP_VERB_KIND = 86;                      // enum JAP_VERB_KIND
...
const int JAP_ADJ_BASE = 87;                       // enum JAP_ADJ_BASE
...
const int JAP_ADJ_FORM2 = 88;                      // enum JAP_ADJ_FORM2
...
const int JAP_TRANSITIVE = 89;                     // enum JAP_TRANSITIVE

const int CASE_jap = 90;                           // enum JAP_CASE
...
const int OBJECT_link = 0;
const int ATTRIBUTE_link = 1;
const int CONDITION_link = 2;
const int CONSEQUENCE_link = 3;
const int SUBJECT_link = 4;
const int RHEMA_link = 5;
const int COVERB_link = 6;
const int NUMBER2OBJ_link = 12;
const int TO_VERB_link = 16;
const int TO_INF_link = 17;
const int TO_PERFECT = 18;
const int TO_UNPERFECT = 19;
const int TO_NOUN_link = 20;
const int TO_ADJ_link = 21;
const int TO_ADV_link = 22;
const int TO_RETVERB = 23;
const int TO_GERUND_2_link = 24;
const int WOUT_RETVERB = 25;
const int TO_ENGLISH_link = 26;
const int TO_RUSSIAN_link = 27;
const int TO_FRENCH_link = 28;
const int SYNONYM_link = 29;
const int SEX_SYNONYM_link = 30;
const int CLASS_link = 31;
const int MEMBER_link = 32;
const int TO_SPANISH_link = 33;
const int TO_GERMAN_link = 34;
const int TO_CHINESE_link = 35;
const int TO_POLAND_link = 36;
const int TO_ITALIAN_link = 37;
const int TO_PORTUGUAL_link = 38;
const int ACTION_link = 39;
const int ACTOR_link = 40;
const int TOOL_link = 41;
const int RESULT_link = 42;
const int TO_JAPANESE_link = 43;
const int TO_KANA_link = 44;
const int TO_KANJI_link = 45;
const int ANTONYM_link = 46;
const int EXPLANATION_link = 47;
const int WWW_link = 48;
const int ACCENT_link = 49;
const int YO_link = 50;
const int TO_DIMINUITIVE_link = 51;
const int TO_RUDE_link = 52;
const int TO_BIGGER_link = 53;
const int TO_NEUTRAL_link = 54;
const int TO_SCOLARLY = 55;
const int TO_SAMPLE_link = 56;
const int USAGE_TAG_link = 57;
const int PROPERTY_link = 58;
const int TO_CYRIJI_link = 59;
const int HABITANT_link = 60;
const int CHILD_link = 61;
const int PARENT_link = 62;
const int UNIT_link = 63;
const int SET_link = 64;
const int TO_WEAKENED_link = 65;
const int VERBMODE_BASIC_link = 66;
const int NEGATION_PARTICLE_link = 67;
const int NEXT_COLLOCATION_ITEM_link = 68;
const int SUBORDINATE_CLAUSE_link = 69;
const int RIGHT_GENITIVE_OBJECT_link = 70;
const int ADV_PARTICIPLE_link = 71;
const int POSTFIX_PARTICLE_link = 72;
const int INFINITIVE_link = 73;
const int NEXT_ADJECTIVE_link = 74;
const int NEXT_NOUN_link = 75;
const int THEMA_link = 76;
const int RIGHT_AUX2INFINITIVE_link = 77;
const int RIGHT_AUX2PARTICIPLE = 78;
const int RIGHT_AUX2ADJ = 79;
const int RIGHT_LOGIC_ITEM_link = 80;
const int RIGHT_COMPARISON_Y_link = 81;
const int RIGHT_NOUN_link = 82;
const int RIGHT_NAME_link = 83;
const int ADJ_PARTICIPLE_link = 84;
const int PUNCTUATION_link = 85;
const int IMPERATIVE_SUBJECT_link = 86;
const int IMPERATIVE_VERB2AUX_link = 87;
const int AUX2IMPERATIVE_VERB = 88;
const int PREFIX_PARTICLE_link = 89;
const int PREFIX_CONJUNCTION_link = 90;
const int LOGICAL_CONJUNCTION_link = 91;
const int NEXT_CLAUSE_link = 92;
const int LEFT_AUX_VERB_link = 93;
const int BEG_INTRO_link = 94;
const int RIGHT_PREPOSITION_link = 95;
const int WH_SUBJECT_link = 96;
const int IMPERATIVE_PARTICLE_link = 97;
const int GERUND_link = 98;
const int PREPOS_ADJUNCT_link = 99;
const int DIRECT_OBJ_INTENTION_link = 100;
const int COPULA_link = 101;
const int DETAILS_link = 102;
const int SENTENCE_CLOSER_link = 103;
const int OPINION_link = 104;
const int APPEAL_link = 105;
const int TERM_link = 106;
const int SPEECH_link = 107;
const int QUESTION_link = 108;
const int POLITENESS_link = 109;
const int SEPARATE_ATTR_link = 110;
const int POSSESSION_POSTFIX_link = 111;
const int COMPOUND_PREFIX_link = 112;
const int UNKNOWN_SLOT_link = 113;
const int SECOND_VERB_link = 114;
