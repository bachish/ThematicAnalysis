...
const int TRANSITIVENESS_ru = 14;                  // enum ПЕРЕХОДНОСТЬ
...
const int SHORTNESS_ru = 21;                       // enum КРАТКИЙ

const int CASE_ru = 23;                            // enum ПАДЕЖ
...
const int CASE_GERUND_ru = 27;                     // enum ПадежВал
// Coordiname ПадежВал states:

const int MODAL_ru = 28;                           // enum МОДАЛЬНЫЙ

const int VERBMODE_TENSE = 29;                     // enum СГД_Время
// Coordiname СГД_Время states:

const int VERBMODE_DIRECTION = 30;                 // enum СГД_Направление
// Coordiname СГД_Направление states:

const int NUMERAL_CATEGORY = 31;                   // enum КАТЕГОРИЯ_ЧИСЛ
// Coordiname КАТЕГОРИЯ_ЧИСЛ states:
const int CARDINAL = 0;                            // КАТЕГОРИЯ_ЧИСЛ : КОЛИЧ
const int COLLECTION = 1;                          // КАТЕГОРИЯ_ЧИСЛ : СОБИР

const int ADV_SEMANTICS = 32;                      // enum ОБСТ_ВАЛ
...
const int ADV_MODIF_TYPE = 37;                     // enum ТИП_МОДИФ
// Coordiname ТИП_МОДИФ states:

const int TENSE_en = 44;                           // enum TENSE
...
const int DURATION_en = 45;                        // enum DURATION
...
const int PRONOUN_FORM_en = 49;                    // enum PRONOUN_FORM
// Coordiname PRONOUN_FORM states:

const int ADJ_FORM_en = 50;                        // enum ADJ_FORM
...
const int COMPARABILITY_en = 51;                   // enum COMPARABILITY
...
const int VERB_FORM_en = 52;                       // enum VERB_FORM
...
const int OBLIG_TRANSITIVITY_en = 58;              // enum OBLIG_TRANSITIVITY

const int PROPER_NOUN_en = 59;                     // enum ENG_PROPER_NOUN

const int MASS_NOUN_en = 60;                       // enum ENG_MASS_NOUN

const int PERSON_fr = 61;                          // enum FR_PERSON
...
const int FR_PRONOUN_FORM = 65;                    // enum FR_PRONOUN_FORM
...
const int TRANSITIVITY_fr = 66;                    // enum FR_TRANSITIVITY
...
const int VERB_FORM_fr = 67;                       // enum FR_VERB_FORM
...
const int JAP_FORM = 68;                           // enum JAP_FORM
...
const int JAP_VERB_BASE = 69;                      // enum JAP_VERB_BASE
...
const int JAP_VERB_KIND = 70;                      // enum JAP_VERB_KIND
...
const int JAP_ADJ_BASE = 71;                       // enum JAP_ADJ_BASE
...
const int JAP_ADJ_FORM2 = 72;                      // enum JAP_ADJ_FORM2
...
const int JAP_TRANSITIVE = 73;                     // enum JAP_TRANSITIVE

const int CASE_jap = 74;                           // enum JAP_CASE
