#if !defined ThesaurusStorage_MySQL__h && defined SOL_MYSQL_DICTIONARY_STORAGE
 #define ThesaurusStorage_MySQL__h
 ...
 namespace Solarix
 {
  class ThesaurusStorage_MySQL : public ThesaurusStorage
  {
   private:
    ...
    void Connect();
    void Disconnect();
    ThesaurusStorage_MySQL();

   public:
    ThesaurusStorage_MySQL( StorageConnection_MySQL *_cnx );

    virtual ~ThesaurusStorage_MySQL();
