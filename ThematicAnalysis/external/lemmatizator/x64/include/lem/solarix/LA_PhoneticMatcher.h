...
namespace Solarix
{
    ...
    *********************************************************************/
    struct LA_PhoneticRuleGroup : lem::NonCopyable
    {
        ...
        inline bool empty() const { return rules.empty(); }
    };
    ...
    public:
        ...
        ~LA_PhoneticMatcherForLanguage();

        void Load(Solarix::Dictionary *dict, LexiconStorage *storage);

        int GetMinContext() const { return min_context; }
        int GetMaxContext() const { return max_context; }
        ...
        LA_PhoneticRuleEnumerator* EnumerateRules() const;
    };
